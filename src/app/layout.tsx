...
export const metadata: Metadata = {
  title: "Brew Haven - Premium Coffee Roastery",
  description: "Discover exceptional, single-origin coffee roasted fresh daily. Visit our coffee shop for the perfect brew crafted by expert baristas.",
  keywords: "specialty coffee, coffee beans, roastery, single origin, premium espresso",
  ...
  openGraph: {
    title: "Brew Haven - Premium Coffee Roastery",
    description: "Discover exceptional, single-origin coffee roasted fresh daily.",
    url: "https://brewhaven.com",
    siteName: "Brew Haven",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1765964660704-upnd5k1p.jpg",
        alt: "Premium espresso with latte art"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "Brew Haven - Premium Coffee Roastery",
    description: "Exceptional, single-origin coffee roasted fresh daily.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1765964660704-upnd5k1p.jpg"]
  },
  robots: {
    index: true,
    follow: true
